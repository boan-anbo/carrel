...
export class Fireflies extends Message<Fireflies> {
   ...
   * all tags
   *
   * @generated from field: repeated carrel.common.firefly.v1.Firefly all_fireflies = 1;
   */
   ...
   * all tags count
   *
   * @generated from field: int32 all_fireflies_count = 2;
   */
  allFirefliesCount = 0;
   ...
   * Marker: [[Note]] or [[N]]
   *
   * @generated from field: repeated carrel.common.firefly.v1.Firefly notes = 3;
   */
  notes: Firefly[] = [];
   ...
   * Marker: [[Todo]] or [[T]]
   *
   * @generated from field: repeated carrel.common.firefly.v1.Firefly todos = 5;
   */
  todos: Firefly[] = [];
   ...
   * Marker: [[Idea]] or [[I]]
   *
   * @generated from field: repeated carrel.common.firefly.v1.Firefly ideas = 7;
   */
  ideas: Firefly[] = [];
   ...
   * Marker: [[Summary]] or [[S]]
   *
   * @generated from field: repeated carrel.common.firefly.v1.Firefly summaries = 9;
   */
  summaries: Firefly[] = [];
   ...
   * Marker: [[Point]] or [[P]]
   *
   * @generated from field: repeated carrel.common.firefly.v1.Firefly points = 11;
   */
  points: Firefly[] = [];
   ...
   * Marker: [[Fact]] or [[F]]
   *
   * @generated from field: repeated carrel.common.firefly.v1.Firefly facts = 13;
   */
  facts: Firefly[] = [];
   ...
   * Marker: [[Quote]] or [[Q]]
   *
   * @generated from field: repeated carrel.common.firefly.v1.Firefly quotes = 15;
   */
  quotes: Firefly[] = [];
   ...
   * Marker: [[Question]] or [[?]]
   *
   * @generated from field: repeated carrel.common.firefly.v1.Firefly questions = 17;
   */
  questions: Firefly[] = [];
   ...
   * Marker: [[Keyword]] or [[K]]
   *
   * @generated from field: repeated carrel.common.firefly.v1.Firefly keywords = 19;
   */
  keywords: Firefly[] = [];
   ...
   *
   * @generated from field: repeated carrel.common.firefly.v1.Firefly references = 21;
   */
  references: Firefly[] = [];
   ...
   * Marker: [[OPoint]] or [[OP]]
   *
   * @generated from field: repeated carrel.common.firefly.v1.Firefly opoints = 23;
   */
  opoints: Firefly[] = [];
   ...
   *
   * @generated from field: repeated carrel.common.firefly.v1.Firefly oevidences = 25;
   */
  oevidences: Firefly[] = [];
   ...
   * Marker: [[Data]] or [[D]]
   *
   * @generated from field: repeated carrel.common.firefly.v1.Firefly data = 27;
   */
  data: Firefly[] = [];
   ...
   *
   * @generated from field: repeated carrel.common.firefly.v1.Firefly unclassified = 29;
   */
  unclassified: Firefly[] = [];
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "all_fireflies", kind: "message", T: Firefly, repeated: true },
    { no: 2, name: "all_fireflies_count", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 3, name: "notes", kind: "message", T: Firefly, repeated: true },
    { no: 4, name: "notes_count", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 5, name: "todos", kind: "message", T: Firefly, repeated: true },
    { no: 6, name: "todos_count", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 7, name: "ideas", kind: "message", T: Firefly, repeated: true },
    { no: 8, name: "ideas_count", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 9, name: "summaries", kind: "message", T: Firefly, repeated: true },
    { no: 10, name: "summaries_count", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 11, name: "points", kind: "message", T: Firefly, repeated: true },
    { no: 12, name: "points_count", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 13, name: "facts", kind: "message", T: Firefly, repeated: true },
    { no: 14, name: "facts_count", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 15, name: "quotes", kind: "message", T: Firefly, repeated: true },
    { no: 16, name: "quotes_count", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 17, name: "questions", kind: "message", T: Firefly, repeated: true },
    { no: 18, name: "questions_count", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 19, name: "keywords", kind: "message", T: Firefly, repeated: true },
    { no: 20, name: "keywords_count", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 21, name: "references", kind: "message", T: Firefly, repeated: true },
    { no: 22, name: "references_count", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 23, name: "opoints", kind: "message", T: Firefly, repeated: true },
    { no: 24, name: "opoints_count", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 25, name: "oevidences", kind: "message", T: Firefly, repeated: true },
    { no: 26, name: "oevidences_count", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 27, name: "data", kind: "message", T: Firefly, repeated: true },
    { no: 28, name: "data_count", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 29, name: "unclassified", kind: "message", T: Firefly, repeated: true },
