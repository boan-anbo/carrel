...
export class StandardQueryResultMetadata extends Message<StandardQueryResultMetadata> {
  ...
  /**
   * @generated from field: int32 pages = 6;
   */
  pages = 0;

  /**
   * @generated from field: int32 total_result_count = 7;
   */
  totalResultCount = 0;

  /**
   * @generated from field: generic.api.query.v1.StandardQuery query = 8;
   */
  query?: StandardQuery;
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 2, name: "result_count", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 3, name: "offset", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 4, name: "length", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 5, name: "page", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 6, name: "pages", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 7, name: "total_result_count", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    { no: 8, name: "query", kind: "message", T: StandardQuery },
  ]);
