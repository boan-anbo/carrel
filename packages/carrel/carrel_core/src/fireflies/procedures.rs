...
pub fn scan_folder_for_fireflies(folder: &str, opt: FireflyKeeperOption) -> Result<Fireflies, CarrelCoreError> {
...
pub fn scan_file_for_fireflies(file: &[&str], opt: FireflyKeeperOption) -> Result<Fireflies, CarrelCoreError> {
