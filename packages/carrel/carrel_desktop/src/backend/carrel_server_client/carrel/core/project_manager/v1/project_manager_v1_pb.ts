...
// @generated from file carrel/layout/project_manager/v1/project_manager_v1.proto (package carrel.layout.project_manager.v1, syntax proto3)
/* eslint-disable */
/* @ts-nocheck */
...
/**
 * @generated from enum carrel.layout.project_manager.v1.CarrelDbType
 */
...
proto3.util.setEnumType(CarrelDbType, "carrel.layout.project_manager.v1.CarrelDbType", [
 ...
 *
 * @generated from enum carrel.layout.project_manager.v1.ArchiveSourceType
 */
...
proto3.util.setEnumType(ArchiveSourceType, "carrel.layout.project_manager.v1.ArchiveSourceType", [
...
/**
 * @generated from enum carrel.layout.project_manager.v1.TaskState
 */
...
proto3.util.setEnumType(TaskState, "carrel.layout.project_manager.v1.TaskState", [
 ...
 *
 * @generated from message carrel.layout.project_manager.v1.AddArchiveDto
 */
export class AddArchiveDto extends Message<AddArchiveDto> {
   ...
   *
   * @generated from field: carrel.layout.project_manager.v1.ArchiveSourceType archive_source_type = 4;
   */
  ...
  static readonly typeName = "carrel.layout.project_manager.v1.AddArchiveDto";
 ...
 *
 * @generated from message carrel.layout.project_manager.v1.CreateProjectRequest
 */
export class CreateProjectRequest extends Message<CreateProjectRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "carrel.layout.project_manager.v1.CreateProjectRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "description", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message carrel.layout.project_manager.v1.ProjectInfo
 */
export class ProjectInfo extends Message<ProjectInfo> {
   ...
   * Carrel db type
   *
   * @generated from field: carrel.layout.project_manager.v1.CarrelDbType db_type = 8;
   */
  ...
  static readonly runtime = proto3;
  static readonly typeName = "carrel.layout.project_manager.v1.ProjectInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message carrel.layout.project_manager.v1.Task
 */
export class Task extends Message<Task> {
  ...
  /**
   * @generated from field: carrel.layout.project_manager.v1.TaskState state = 5;
   */
  ...
  static readonly runtime = proto3;
  static readonly typeName = "carrel.layout.project_manager.v1.Task";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
