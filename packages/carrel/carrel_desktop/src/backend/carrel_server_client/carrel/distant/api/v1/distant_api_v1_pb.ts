...
// @generated from file carrel/distant/api/v1/distant_api_v1.proto (package carrel.distant.api.v1, syntax proto3)
/* eslint-disable */
/* @ts-nocheck */

import type {BinaryReadOptions, FieldList, JsonReadOptions, JsonValue, PartialMessage, PlainMessage} from "@bufbuild/protobuf";
import {Message, proto3, protoInt64} from "@bufbuild/protobuf";
import {Passage} from "../../../common/passage/v1/passage_v1_pb";

/**
 * @generated from message carrel.distant.api.v1.DistantApiSearchRequest
 */
export class DistantApiSearchRequest extends Message<DistantApiSearchRequest> {
  ...
  static readonly typeName = "carrel.distant.api.v1.DistantApiSearchRequest";
...
/**
 * @generated from message carrel.distant.api.v1.DistantApiSearchResponse
 */
export class DistantApiSearchResponse extends Message<DistantApiSearchResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "carrel.distant.api.v1.DistantApiSearchResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message carrel.distant.api.v1.DistantApiScrollRequest
 */
export class DistantApiScrollRequest extends Message<DistantApiScrollRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "carrel.distant.api.v1.DistantApiScrollRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message carrel.distant.api.v1.IndexInfo
 */
export class IndexInfo extends Message<IndexInfo> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "carrel.distant.api.v1.IndexInfo";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message carrel.distant.api.v1.DistantListIndexResponse
 */
export class DistantListIndexResponse extends Message<DistantListIndexResponse> {
  /**
   * @generated from field: repeated carrel.distant.api.v1.IndexInfo indices = 1;
   */
  indices: IndexInfo[] = [];
  ...
  static readonly runtime = proto3;
  static readonly typeName = "carrel.distant.api.v1.DistantListIndexResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
