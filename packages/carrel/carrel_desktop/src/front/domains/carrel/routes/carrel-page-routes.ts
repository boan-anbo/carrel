...
export const CarrelPageRoutes: TCarrelPageRoutes = {
    ...
    [ECarrelPages.MainWorkArea]: {
        absolutePath: appDomainRoutes[CarrelComponent.CARREL_UNSPECIFIED] + ECarrelPages.MainWorkArea,
        relativePath: ECarrelPages.MainWorkArea
    },
    [ECarrelPages.BOARD]: {
