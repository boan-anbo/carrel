...
// @generated from file common/document/v1/document.proto (package carrel.common.document.v1, syntax proto3)
/* eslint-disable */
/* @ts-nocheck */
...
import {File} from "../../file/v1/file_pb.js";
...
export class Document extends Message<Document> {
   ...
   * / publication date
   *
   * @generated from field: string publicationDate = 5;
   */
  publicationDate = "";
   ...
   *
   * @generated from field: int64 modified = 13;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 5, name: "publicationDate", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    ...
    { no: 13, name: "modified", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
