...
/**
 * @generated from message carrel.server.scaffold.v1.ScaffoldNewProjectRequest
 */
export class ScaffoldNewProjectRequest extends Message<ScaffoldNewProjectRequest> {
  ...
  static readonly typeName = "carrel.server.scaffold.v1.ScaffoldNewProjectRequest";
...
/**
 * @generated from message carrel.server.scaffold.v1.ScaffoldNewProjectResponse
 */
export class ScaffoldNewProjectResponse extends Message<ScaffoldNewProjectResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "carrel.server.scaffold.v1.ScaffoldNewProjectResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
