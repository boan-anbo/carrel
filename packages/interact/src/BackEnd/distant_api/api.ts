 ...
 * 
 * @export
 * @interface DistantListIndexResponse
 */
export interface DistantListIndexResponse {
    /**
     * count sint32
     * @type {number}
     * @memberof DistantListIndexResponse
     */
    'count': number;
    /**
     * 
...
/**
 * CratecontrollerlistIndicesApi - axios parameter creator
 * @export
 */
export const CratecontrollerlistIndicesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
         ...
         */
        listIndices: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/list_indices`;
...
/**
 * CratecontrollerlistIndicesApi - functional programming interface
 * @export
 */
export const CratecontrollerlistIndicesApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = CratecontrollerlistIndicesApiAxiosParamCreator(configuration)
    return {
        /**
         * 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async listIndices(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DistantListIndexResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listIndices(options);
...
/**
 * CratecontrollerlistIndicesApi - factory interface
 * @export
 */
export const CratecontrollerlistIndicesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = CratecontrollerlistIndicesApiFp(configuration)
    return {
        /**
         * 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        listIndices(options?: any): AxiosPromise<DistantListIndexResponse> {
            return localVarFp.listIndices(options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * CratecontrollerlistIndicesApi - object-oriented interface
 * @export
 * @class CratecontrollerlistIndicesApi
 * @extends {BaseAPI}
 */
export class CratecontrollerlistIndicesApi extends BaseAPI {
    /**
     * 
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof CratecontrollerlistIndicesApi
     */
    public listIndices(options?: AxiosRequestConfig) {
        return CratecontrollerlistIndicesApiFp(this.configuration).listIndices(options).then((request) => request(this.axios, this.basePath));
    }
}
