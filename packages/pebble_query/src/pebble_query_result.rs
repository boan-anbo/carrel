...
use carrel_commons::generic::api::query::v1::{StandardQuery, StandardQueryResultMetadata};
...
impl<T: EntityTrait> PebbleQueryResult<T> {
    pub fn new(results: Vec<T::Model>, query: StandardQuery, items_and_pages_num: ItemsAndPagesNumber) -> Self {
