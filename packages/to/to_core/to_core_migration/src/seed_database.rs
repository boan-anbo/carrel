...
use crate::m20220929_111159_create_db::{ TextualObject};
use crate::Query;
...
pub async fn seed_database<'a>(manager: &'a SchemaManager<'a>) {
    ...
    //     .columns(vec![
    //         TextualObject::Name,
    //         TextualObject::Description,
    //         TextualObject::Directory,
    //         TextualObject::DbName,
    //         TextualObject::ToName,
    //         TextualObject::CreateAt,
    //         TextualObject::UpdatedAt,
    //     ])
    //     .values_panic([
    //         "seed_name".into(),
